...
%We have changed the memory backend that enables HMCSim integration. We have expanded the capabilities to have multiple HMC devices, as well as tried to created a map in order to allocate memory evenly over all devices. This is to actually see some kind of latency at all. 
